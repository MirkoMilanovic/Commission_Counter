...
def test_commission_10():
    assert get_commission('2022-01-10', 'airbnb') == 10
    assert get_commission('2022-05-10', 'airbnb') == 10
    assert get_commission('2022-10-10', 'airbnb') == 10
    assert get_commission('2022-12-10', 'airbnb') == 10
    assert get_commission('10 January, 2022', 'bcom') == 10
    assert get_commission('10 May, 2022', 'bcom') == 10
    assert get_commission('10 October, 2022', 'bcom') == 10
    assert get_commission('10 December, 2022', 'bcom') == 10
